...
export default function ProductCard({ product, onEdit, onDelete }) {
  ...
  return (
    <div className="p-3 w-full max-w-sm">
      <Card
        key={product._id}
        className="relative flex flex-col items-center group rounded-lg shadow-lg  p-3"
      >
        ...
        <CardBody className="flex flex-col items-center justify-between h-32">
          ...
          <div className="flex gap-4 mt-4 w-full">
            <Button
              ...
              className="flex-1 flex items-center justify-center text-lg text-black bg-white"
            >
              <FontAwesomeIcon icon={faEdit} className="mr-1" />
            </Button>
            <Button
              onClick={() => onDelete(product)}
              className="flex-1 flex items-center justify-center text-lg text-red-500 hover:text-red-700 bg-white"
            >
