...
export default function Orders() {
  ...
  return (
    <div className="relative pb-[500px] sm:w-full">
        ...
        <div className="p-4 sm:p-6 md:p-10 max-w-4xl mx-[10px] bg-white rounded-lg shadow-lg">
          {error ? (
            ...
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-6 font-bold border-b text-xs sm:text-sm md:text-base lg:text-lg text-[#525252] py-3 text-center bg-gray-100">
                ...
                <div className="font-eb-garamond hidden md:block">Delivery Status</div>
              ...
              {currentOrders.map((order) => (
                ...
                >
                  ...
                  <div className="font-eb-garamond hidden md:block">{order.orderTotal} $</div>
